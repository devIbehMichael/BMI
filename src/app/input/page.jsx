...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-2 justify-center items-center min-h-screen"    style={{ backgroundImage: `url(${img6.src})` }}>
      <h1 className="text-4xl font-semibold font-title">BMI Calculator</h1>
      <form onSubmit={handleCalculate}>
        <div className="flex flex-col gap-3 items-center">
          ...
          <Image
              ...
              className={`h-[200px] w-[200px] ${gender === "male" ? "bg-[#0c205a] rounded-3xl shadow-lg" : ""}`}
            />
            ...
            <Image
              ...
              className={`h-[200px] w-[200px] ${gender === "female" ? "bg-[#0c205a] rounded-3xl shadow-lg" : ""}`}
            />
          </div>
          ...
          <button
            type="submit"
            className="px-6 py-3 bg-[#0c205a] rounded-xl my-4 text-2xl text-white font-title shadow-lg"
          >
            Calculate BMI
          </button>
        </div>
